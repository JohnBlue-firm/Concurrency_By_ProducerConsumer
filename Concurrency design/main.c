...
// Struct to hold the buffer and semaphores
...
void initTransferBuffer(struct TransferBuffer *trans, struct Buffer *first, struct Buffer *second) { // Initialization
    trans->from = first;
    trans->to = second;
}
